    ...
    <main className="min-h-screen overflow-x-hidden bg-gray-950 text-white">
      ...
      <div className="min-h-screen md:flex">
        ...
        <section className="min-w-0 flex-1 px-4 py-6 sm:px-6 sm:py-8 md:p-10">
          ...
          {message && (
            <div className="mb-6 rounded-lg border border-green-900 bg-green-950 p-4 text-sm text-green-300">
              {message}
            </div>
          )}
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <span
                      className={
                        utilisateur.role === "ADMIN"
                          ? "w-fit rounded-full bg-purple-950 px-3 py-1 text-sm text-purple-300"
                          : "w-fit rounded-full bg-gray-800 px-3 py-1 text-sm text-gray-300"
                      }
                    >
                      {utilisateur.role === "ADMIN"
                        ? "👑 ADMIN"
                    ...
                    {utilisateur.user_id !==
                      ...
                      <button
                        ...
                        className="rounded-lg border border-gray-700 px-4 py-3 text-sm text-gray-300 hover:bg-gray-800 disabled:opacity-50"
                      >
                        {modification ===
                          utilisateur.user_id
                          ? "Modification..."
          ...
          <div className="mt-6 rounded-2xl border border-gray-800 bg-gray-900 p-5 sm:p-6">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex flex-col gap-3 rounded-lg border border-gray-800 p-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <span className="w-fit shrink-0 rounded-full bg-green-950 px-3 py-1 text-sm text-green-400">
                  🟢 Actif
                </span>
              ...
              <div className="flex flex-col gap-3 rounded-lg border border-gray-800 p-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <span className="w-fit shrink-0 rounded-full bg-red-950 px-3 py-1 text-sm text-red-400">
                  🔴 Désactivé
                </span>
