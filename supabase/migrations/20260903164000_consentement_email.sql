-- Ajoute un consentement e-mail distinct du consentement SMS.
alter table public.clients
  add column if not exists email_consentement boolean not null default false,
  add column if not exists email_consentement_date timestamptz;
